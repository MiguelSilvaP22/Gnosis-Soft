		...
		<div class="col-xs-12">
			...
			<div class="box">
				...
				<div class='form-group'>
					...
					{!! Form::text('rut_matriz_empresa', null, ['class' => 'form-control','id'=>'rut_matriz_empresa','maxlength'=>'10','readonly' => true]) !!}
				...
				<div class='form-group'>
					...
					{!! Form::select('id_region', $regiones,$idRegion ,['class' => 'select2','placeholder'=>'Seleccione una región','id'=>'id_region', 'style'=>'width:100%']) !!}
